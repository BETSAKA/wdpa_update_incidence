...
author: "Florent Bédécarrats, Ollier Andrianambinina, Ingrid Dallmann, Seheno Ramanantsoa et Melvin Wong"
...
La figure suivante présente la couverture des aires protégées de Madagascar avant (en bleu avec transparence) et après (en rouge avec transparence) la correction survenue en décembre 2024. Compte tenu de la transparence, les zones considérées comme protégées dans les deu jeux de données apparaissent en violet, celles qui étaient considérées comme conservées que dans les données jusqu'en 2024 apparaissent en bleu et celles sui sont considérées comme conservées que depuis la correction apparaîssent en rouge. 
...
ggplot(ap_var2, aes(x = area_ha_diff, y = defor_pct_diff)) +
  ...
  labs(
    title = paste0("Variation du taux de déforestation pour les AP avec variations de surface >", seuil, "%"),
